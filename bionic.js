...
function update() {
    ...
    if (ball.y <= 0) {
        ...
        //game over
        context.font = "20.67px oblique";
        context.fillStyle = "lightcoral";
        context.fillText("Chai, you don lose: Press 'Space' to Restart", 42, 359.999);
        gameOver = true;
    }
...
function detectCollision(a, b) {
    return a.x < b.x + b.width && //a's top left corner doesn't reach b's top right corner
           ...
           a.y + a.height > b.y;  //a's bottom left corner passes b's top top left corner
}
...
function bottomCollision(ball, block) { //a is below b (ball is below block)
    return detectCollision(ball, block) && (block.y + ball.height) >= ball.y;
}
